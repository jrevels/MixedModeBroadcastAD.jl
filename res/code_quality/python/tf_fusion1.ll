...
define void @fusion_1(i8* nocapture readonly dereferenceable(16777216) %fusion.2.raw, i8* nocapture readonly dereferenceable(16777216) %tanh.1.raw, i8* nocapture readonly dereferenceable(8192) %arg2.raw, i8* nocapture readonly dereferenceable(8192) %arg1.raw, i8* nocapture dereferenceable(16777216) %fusion.1.raw, i8* noalias nocapture readnone dereferenceable(16777216) %temp_buffer) local_unnamed_addr #0 {
entry:
  %fusion.1.raw10 = addrspacecast i8* %fusion.1.raw to i8 addrspace(1)*
  ...
  %fusion.2.raw2 = addrspacecast i8* %fusion.2.raw to i8 addrspace(1)*
  ...
  %8 = bitcast i8 addrspace(1)* %tanh.1.raw4 to float addrspace(1)*
  %9 = getelementptr inbounds float, float addrspace(1)* %8, i64 %linear_index
  %10 = load float, float addrspace(1)* %9, align 4, !invariant.load !22, !alias.scope !29, !noalias !30
  ...
  %17 = bitcast i8 addrspace(1)* %fusion.2.raw2 to float addrspace(1)*
  %18 = getelementptr inbounds float, float addrspace(1)* %17, i64 %linear_index
  %19 = load float, float addrspace(1)* %18, align 4, !invariant.load !22, !alias.scope !34, !noalias !35
  %20 = fsub fast float 1.000000e+00, %19
  %21 = fmul fast float %19, %10
  %22 = fmul fast float %21, %20
  %23 = fmul fast float %22, %16
  %24 = bitcast i8 addrspace(1)* %fusion.1.raw10 to float addrspace(1)*
  %25 = getelementptr inbounds float, float addrspace(1)* %24, i64 %linear_index
  store float %23, float addrspace(1)* %25, align 4, !alias.scope !36, !noalias !37
  ret void
}