...
define void @fusion_2(i8* nocapture readonly dereferenceable(16777216) %arg5.raw, i8* nocapture dereferenceable(16777216) %fusion.2.raw, i8* noalias nocapture readnone dereferenceable(16777216) %temp_buffer) local_unnamed_addr #0 {
entry:
  %fusion.2.raw4 = addrspacecast i8* %fusion.2.raw to i8 addrspace(1)*
  %arg5.raw2 = addrspacecast i8* %arg5.raw to i8 addrspace(1)*
  ...
  %3 = bitcast i8 addrspace(1)* %arg5.raw2 to float addrspace(1)*
...
__nv_tanhf.exit:                                  ; preds = %if.then.i, %if.else.i
  ...
  %26 = bitcast i8 addrspace(1)* %fusion.2.raw4 to float addrspace(1)*
  %27 = getelementptr inbounds float, float addrspace(1)* %26, i64 %linear_index
  store float %25, float addrspace(1)* %27, align 4, !alias.scope !34, !noalias !35
  ret void
}