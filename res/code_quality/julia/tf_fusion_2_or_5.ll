...
entry:
  %.elt13 = extractvalue [2 x { i64 }] %4, 0
  %5 = extractvalue { i64 } %.elt13, 0
  %.elt15 = extractvalue [2 x { i64 }] %4, 1
  %6 = extractvalue { i64 } %.elt15, 0
  ...
  br i1 %17, label %julia_Kernel_34580.exit, label %L213.i, !dbg !74
...
pass.i:                                           ; preds = %L213.i
  ...
  %.fca.0.0.0.extract = extractvalue { { [2 x i64], { i64 } }, float } %1, 0, 0, 0
  %.fca.0.1.0.extract = extractvalue { { [2 x i64], { i64 } }, float } %1, 0, 1, 0
  %.fca.1.extract = extractvalue { { [2 x i64], { i64 } }, float } %1, 1
  %20 = extractvalue { [2 x i8] } %2, 0
  %.elt5 = extractvalue [2 x i8] %20, 0
  %.elt7 = extractvalue [2 x i8] %20, 1
  %21 = extractvalue { [2 x i64] } %3, 0
  %.elt9 = extractvalue [2 x i64] %21, 0
  %.elt11 = extractvalue [2 x i64] %21, 1
  %22 = add nuw nsw i64 %11, %13, !dbg !95
  %23 = sdiv i64 %22, %5, !dbg !75
  %24 = mul i64 %23, %5, !dbg !97
  %25 = sub i64 %22, %24, !dbg !100
  %26 = add i64 %25, 1, !dbg !102
  %27 = add i64 %23, 1, !dbg !104
  %28 = and i8 %.elt5, 1, !dbg !110
  %29 = icmp eq i8 %28, 0, !dbg !110
  %30 = select i1 %29, i64 %.elt9, i64 %26, !dbg !110
  %31 = and i8 %.elt7, 1, !dbg !119
  %32 = icmp eq i8 %31, 0, !dbg !119
  %33 = select i1 %32, i64 %.elt11, i64 %27, !dbg !119
  %34 = icmp slt i64 %.fca.0.0.0.extract, 0, !dbg !123
  %35 = select i1 %34, i64 0, i64 %.fca.0.0.0.extract, !dbg !123
  %36 = add i64 %33, -1, !dbg !149
  %37 = mul i64 %36, %35, !dbg !159
  %38 = add i64 %37, -1, !dbg !161
  %39 = add i64 %38, %30, !dbg !163
  %40 = inttoptr i64 %.fca.0.1.0.extract to float*, !dbg !165
  %41 = getelementptr float, float* %40, i64 %39, !dbg !165
  %42 = addrspacecast float* %41 to float addrspace(1)*, !dbg !165
  %43 = load float, float addrspace(1)* %42, align 4, !dbg !165
  %44 = fmul fast float %43, %.fca.1.extract, !dbg !175
  %45 = call float @__nv_tanhf(float %44), !dbg !182
  %46 = call fast float @llvm.fmuladd.f32(float %45, float %.fca.1.extract, float %.fca.1.extract), !dbg !190
  %47 = icmp slt i64 %.elt.elt, 0, !dbg !192
  %48 = select i1 %47, i64 0, i64 %.elt.elt, !dbg !192
  %49 = mul i64 %23, %48, !dbg !210
  %50 = add i64 %25, %49, !dbg !218
  %51 = inttoptr i64 %19 to float*, !dbg !220
  %52 = getelementptr float, float* %51, i64 %50, !dbg !220
  %53 = addrspacecast float* %52 to float addrspace(1)*, !dbg !220
  store float %46, float addrspace(1)* %53, align 4, !dbg !220
  br label %julia_Kernel_34580.exit, !dbg !228

julia_Kernel_34580.exit:                          ; preds = %entry, %pass.i
  ret void
}
...
!24 = distinct !DISubprogram(name: "Kernel", linkageName: "julia_Kernel_34580", scope: null, file: !2, line: 53, type: !8, isLocal: false, isDefinition: true, scopeLine: 53, isOptimized: true, unit: !1, variables: !3)
...
!175 = !DILocation(line: 165, scope: !176, inlinedAt: !178)
!176 = distinct !DISubprogram(name: "mul_fast;", linkageName: "mul_fast", scope: !177, file: !177, line: 165, type: !8, isLocal: false, isDefinition: true, scopeLine: 165, isOptimized: true, unit: !1, variables: !3)
!177 = !DIFile(filename: "fastmath.jl", directory: ".")
!178 = !DILocation(line: 203, scope: !179, inlinedAt: !181)
!179 = distinct !DISubprogram(name: "#22;", linkageName: "#22", scope: !180, file: !180, line: 203, type: !8, isLocal: false, isDefinition: true, scopeLine: 203, isOptimized: true, unit: !1, variables: !3)
!180 = !DIFile(filename: "/home/maleadt/Julia/MixedModeBroadcastAD/test/kernels.jl", directory: ".")
!181 = !DILocation(line: 83, scope: !19, inlinedAt: !21)
!182 = !DILocation(line: 114, scope: !183, inlinedAt: !185)
!183 = distinct !DISubprogram(name: "macro expansion;", linkageName: "macro expansion", scope: !184, file: !184, type: !8, isLocal: false, isDefinition: true, isOptimized: true, unit: !1, variables: !3)
!184 = !DIFile(filename: "/home/maleadt/Julia/CUDAnative/src/cgutils.jl", directory: ".")
!185 = !DILocation(line: 48, scope: !186, inlinedAt: !188)
!186 = distinct !DISubprogram(name: "tanh;", linkageName: "tanh", scope: !187, file: !187, line: 48, type: !8, isLocal: false, isDefinition: true, scopeLine: 48, isOptimized: true, unit: !1, variables: !3)
!187 = !DIFile(filename: "/home/maleadt/Julia/CUDAnative/src/device/libdevice.jl", directory: ".")
!188 = !DILocation(line: 6, scope: !189, inlinedAt: !178)
!189 = distinct !DISubprogram(name: "cuda_tanh;", linkageName: "cuda_tanh", scope: !180, file: !180, line: 6, type: !8, isLocal: false, isDefinition: true, scopeLine: 6, isOptimized: true, unit: !1, variables: !3)
!190 = !DILocation(line: 163, scope: !191, inlinedAt: !178)
!191 = distinct !DISubprogram(name: "add_fast;", linkageName: "add_fast", scope: !177, file: !177, line: 163, type: !8, isLocal: false, isDefinition: true, scopeLine: 163, isOptimized: true, unit: !1, variables: !3)
!192 = !DILocation(line: 435, scope: !193, inlinedAt: !194)
!193 = distinct !DISubprogram(name: "max;", linkageName: "max", scope: !125, file: !125, line: 435, type: !8, isLocal: false, isDefinition: true, scopeLine: 435, isOptimized: true, unit: !1, variables: !3)
!194 = !DILocation(line: 195, scope: !195, inlinedAt: !196)
!195 = distinct !DISubprogram(name: "Type;", linkageName: "Type", scope: !128, file: !128, line: 195, type: !8, isLocal: false, isDefinition: true, scopeLine: 195, isOptimized: true, unit: !1, variables: !3)
!196 = !DILocation(line: 197, scope: !197, inlinedAt: !198)
!197 = distinct !DISubprogram(name: "Type;", linkageName: "Type", scope: !128, file: !128, line: 197, type: !8, isLocal: false, isDefinition: true, scopeLine: 197, isOptimized: true, unit: !1, variables: !3)
!198 = !DILocation(line: 152, scope: !199, inlinedAt: !200)
!199 = distinct !DISubprogram(name: "map;", linkageName: "map", scope: !133, file: !133, line: 152, type: !8, isLocal: false, isDefinition: true, scopeLine: 152, isOptimized: true, unit: !1, variables: !3)
!200 = !DILocation(line: 83, scope: !201, inlinedAt: !202)
!201 = distinct !DISubprogram(name: "axes;", linkageName: "axes", scope: !79, file: !79, line: 83, type: !8, isLocal: false, isDefinition: true, scopeLine: 83, isOptimized: true, unit: !1, variables: !3)
!202 = !DILocation(line: 1705, scope: !203, inlinedAt: !204)
!203 = distinct !DISubprogram(name: "_sub2ind;", linkageName: "_sub2ind", scope: !79, file: !79, line: 1705, type: !8, isLocal: false, isDefinition: true, scopeLine: 1705, isOptimized: true, unit: !1, variables: !3)
!204 = !DILocation(line: 971, scope: !205, inlinedAt: !206)
!205 = distinct !DISubprogram(name: "_to_linear_index;", linkageName: "_to_linear_index", scope: !79, file: !79, line: 971, type: !8, isLocal: false, isDefinition: true, scopeLine: 971, isOptimized: true, unit: !1, variables: !3)
!206 = !DILocation(line: 1042, scope: !207, inlinedAt: !208)
!207 = distinct !DISubprogram(name: "_setindex!;", linkageName: "_setindex!", scope: !79, file: !79, line: 1041, type: !8, isLocal: false, isDefinition: true, scopeLine: 1041, isOptimized: true, unit: !1, variables: !3)
!208 = !DILocation(line: 1019, scope: !209, inlinedAt: !181)
!209 = distinct !DISubprogram(name: "setindex!;", linkageName: "setindex!", scope: !79, file: !79, line: 1019, type: !8, isLocal: false, isDefinition: true, scopeLine: 1019, isOptimized: true, unit: !1, variables: !3)
!210 = !DILocation(line: 54, scope: !211, inlinedAt: !212)
!211 = distinct !DISubprogram(name: "*;", linkageName: "*", scope: !48, file: !48, line: 54, type: !8, isLocal: false, isDefinition: true, scopeLine: 54, isOptimized: true, unit: !1, variables: !3)
!212 = !DILocation(line: 1737, scope: !213, inlinedAt: !214)
!213 = distinct !DISubprogram(name: "_sub2ind_recurse;", linkageName: "_sub2ind_recurse", scope: !79, file: !79, line: 1736, type: !8, isLocal: false, isDefinition: true, scopeLine: 1736, isOptimized: true, unit: !1, variables: !3)
!214 = !DILocation(line: 1737, scope: !215, inlinedAt: !216)
!215 = distinct !DISubprogram(name: "_sub2ind_recurse;", linkageName: "_sub2ind_recurse", scope: !79, file: !79, line: 1736, type: !8, isLocal: false, isDefinition: true, scopeLine: 1736, isOptimized: true, unit: !1, variables: !3)
!216 = !DILocation(line: 1721, scope: !217, inlinedAt: !202)
!217 = distinct !DISubprogram(name: "_sub2ind;", linkageName: "_sub2ind", scope: !79, file: !79, line: 1721, type: !8, isLocal: false, isDefinition: true, scopeLine: 1721, isOptimized: true, unit: !1, variables: !3)
!218 = !DILocation(line: 52, scope: !219, inlinedAt: !220)
!219 = distinct !DISubprogram(name: "-;", linkageName: "-", scope: !48, file: !48, line: 52, type: !8, isLocal: false, isDefinition: true, scopeLine: 52, isOptimized: true, unit: !1, variables: !3)
!220 = !DILocation(line: 42, scope: !221, inlinedAt: !222)
!221 = distinct !DISubprogram(name: "macro expansion;", linkageName: "macro expansion", scope: !7, file: !7, type: !8, isLocal: false, isDefinition: true, isOptimized: true, unit: !1, variables: !3)
!222 = !DILocation(line: 133, scope: !223, inlinedAt: !224)
!223 = distinct !DISubprogram(name: "@generated body;", linkageName: "@generated body", scope: !169, file: !169, type: !8, isLocal: false, isDefinition: true, isOptimized: true, unit: !1, variables: !3)
!224 = !DILocation(line: 133, scope: !225, inlinedAt: !226)
!225 = distinct !DISubprogram(name: "unsafe_store!;", linkageName: "unsafe_store!", scope: !169, file: !169, line: 133, type: !8, isLocal: false, isDefinition: true, scopeLine: 133, isOptimized: true, unit: !1, variables: !3)
!226 = !DILocation(line: 84, scope: !227, inlinedAt: !206)
!227 = distinct !DISubprogram(name: "setindex!;", linkageName: "setindex!", scope: !174, file: !174, line: 82, type: !8, isLocal: false, isDefinition: true, scopeLine: 82, isOptimized: true, unit: !1, variables: !3)
!228 = !DILocation(line: 85, scope: !19, inlinedAt: !21)
